...
final_gb.load_model(saveInProjectRepo('models/XGB_Income/student%%I/XGB.pickle.dat'))


#Loading encoding file 
with open(saveInProjectRepo('data/UCI_Income/student%%I/encoding.json'), 'r') as file:
